...
(function (L08_Canvas) {
    ...
    function init(_event) {
        ...
        drawSeaweed(910, 700);
        drawSeaweed(930, 715);
        //Math.random f�r Luftblasen
        for (let i = 0; i < 10; i++) {
            let x = (740);
            let y = Math.random() * 625;
            drawBubbles(x, y, 10);
        }
        //Math.random f�r Fische
        for (let i = 0; i < 4; i++) {
    ...
    //Funktionen f�r Schatzkiste
    function drawChestCover(_x, _y) {
        ctx.beginPath();
    ...
    function drawChestBottom(_x, _y, _width, _height) {
        //crc2.stroke();
        ctx.beginPath();
        crc2.fillStyle = "rgb(102, 51, 0)";
